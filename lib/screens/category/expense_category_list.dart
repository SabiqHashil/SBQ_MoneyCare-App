...
// Creating a stateless widget for displaying the list of expense categories
class ExpenseCategoryList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Using a ValueListenableBuilder to automatically rebuild the widget when the expenseCategoryListListener changes
    return ValueListenableBuilder(
      // Listening to changes in the expenseCategoryListListener from the CategoryDB
